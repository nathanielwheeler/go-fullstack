...
var (
	...
	// ErrIDInvalid indicates an invalid ID is provided to a method like Delete.
	...
	// ErrPasswordInvalid is returned when an invalid password is is used when attempting to authenticate a user.
...
// User is a model for the users of the website.
type User struct {
	gorm.Model
	Name         string
...
// NewUserService is a constructor for userService.  Calls constructors for user gorm and user validator.
